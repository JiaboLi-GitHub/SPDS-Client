	...
	qint32 pos3, qint32 pos4, qint32 pos5)
{
	...
	{
		slice0 = new QPieSlice(u8"Õý³£", pos0);
	...
	else
	{
		if (pos1)
		{
			slice1 = new QPieSlice(u8"ÍÐÍ·", pos1);
		...
		if (pos2)
		{
			slice2 = new QPieSlice(u8"Ç°Çã", pos2);
		...
		if (pos3)
		{
			slice3 = new QPieSlice(u8"ºóÇã", pos3);
		...
		if (pos4)
		{
			slice4 = new QPieSlice(u8"×óÇã", pos4);
		...
		if (pos5)
		{
			slice5 = new QPieSlice(u8"ÓÒÇã", pos5);
